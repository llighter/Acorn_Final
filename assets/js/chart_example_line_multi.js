...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            label: '아이폰5',
            lineTension : ['0.1'],
            data: [500000, 480000, 450000, 420000, 410000, 420000, 410000, 350000, 340000, 330000, 360000, 350000],
            backgroundColor: 'rgba(66, 160, 167, 0.2)',
            borderColor: 'rgba(66, 160, 167, 0.7)',
            pointStyle : 'triangle',
            pointBorderColor : 'rgba(66, 160, 167, 1)',
            pointHoverBackgroundColor : 'rgba(66, 160, 167, 1)',
            pointRadius : '3',
            pointHoverRadius : '5',
            fill: false,
        },{
            ...
            label : '아이폰5s',
            lineTension : ['0.1'],
            data: [550000, 530000, 510000, 520000, 510000, 500000, 495000, 460000, 455000, 460000, 455000, 450000],
            backgroundColor: 'rgba(205, 255, 102, 0.2)',
            borderColor: 'rgba(205, 255, 102, 0.7)',
            pointStyle : 'rectRot',
            pointBorderColor : 'rgba(205, 205, 100, 1)',
            pointHoverBackgroundColor : 'rgba(205, 205, 100, 1)',
            pointRadius : '3',
            pointHoverRadius : '5',
            fill: '-1',
