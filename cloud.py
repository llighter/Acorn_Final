...
def crawl(startno, endno, counter):
    ...
    for no in range(startno, endno):
        try:
            ...
            print("#########################" + str(no) + " gaierror#########################")
            no += 1
            crawl(no, endno, counter)
        except IOError:
            print("#########################" + str(no) + " IOError#########################")
            no += 1
            crawl(no, endno, counter)
        except ConnectionRefusedError:
            print("#########################" + str(no) + " ConnectionRefusedError#########################")
            no += 1
            crawl(no, endno, counter)
        except requests.packages.urllib3.exceptions.TimeoutError:
            print("#########################" + str(no) + " requests.packages.urllib3.exceptions.TimeoutError#########################")
            no += 1
            crawl(no, endno, counter)
        except requests.packages.urllib3.exceptions.ProtocolError:
            print("#########################" + str(no) + " requests.packages.urllib3.exceptions.ProtocolError#########################")
            no += 1
            crawl(no, endno, counter)
            ...
            print("#########################" + str(no) + " urllib3.exceptions.NewConnectionError#########################")
            no += 1
            crawl(no, endno, counter)
        except ConnectionError:
            print("#########################" + str(no) + " ConnectionError#########################")
            no += 1
            crawl(no, endno, counter)
        except requests.exceptions.ConnectionError:
            print("#########################" + str(no) + " requests.exceptions.ConnectionError#########################")
            no += 1
            crawl(no, endno, counter)
        except requests.exceptions.RequestException:
            print("#########################" + str(no) + " requests.exceptions.RequestException#########################")
            no += 1
            crawl(no, endno, counter)
        except urllib3.exceptions.MaxRetryError:
            print("#########################" + str(no) + " urllib3.exceptions.MaxRetryError#########################")
            no += 1
            crawl(no, endno, counter)
        except TypeError:
            print("#########################" + str(no) + " TypeError#########################")
            no += 1
            crawl(no, endno, counter)
        except Exception:
            print("#########################" + str(no) + " Exception#########################")
            no += 1
            crawl(no, endno, counter)
        except:
            print("#########################" + str(no) + " Exception#########################")
...
if __name__ == '__main__':
    ...
    result = Queue()
    pr1 = Process(target=crawl, args=(10502082, 11000000, 1))
    pr2 = Process(target=crawl, args=(11506022, 12000000, 2))
    pr3 = Process(target=crawl, args=(12800127, 13000000, 3))
    pr4 = Process(target=crawl, args=(13660329, 14000000, 4))
    pr5 = Process(target=crawl, args=(14263622, 15000000, 5))
    pr6 = Process(target=crawl, args=(15258087, 16000000, 6))
    pr7 = Process(target=crawl, args=(16263848, 17000000, 7))
